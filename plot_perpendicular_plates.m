...
set(figure(6),'PaperSize',[1.1*paper_size, paper_size])
full_file_name = output_path + "nonsharing-perp-plates-1x1-e-only-convergence.pdf";
pause(1.5)
exportgraphics(figure(6), full_file_name)
hold off
...
set(figure(7),'PaperSize',[1.1*paper_size, paper_size])
full_file_name = output_path + "nonsharing-perp-plates-1x1-convergence.pdf";
pause(1.5)
exportgraphics(figure(7), full_file_name)
hold off
...
yticks([1e-3,1e-2,1e-1,1e0,1e1,1e2])
set(gca, "FontSize", 18)
set(figure(8),'Units','centimeters')
set(figure(8),'PaperUnits','centimeters')
set(figure(8),'PaperSize',[1.1*paper_size, paper_size])
full_file_name = output_path + "nonsharing-perp-plates-1x1-runtime.pdf";
pause(1.5)
exportgraphics(figure(8), full_file_name)
hold off